...
// ClassifyDoc.cpp : CClassifyDoc 클래스의 구현
//
...
// 축소판 그림을 지원합니다.
void CClassifyDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
...
// 검색 처리기를 지원합니다.
void CClassifyDoc::InitializeSearchContent()
{
...
void CClassifyDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
